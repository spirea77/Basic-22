...
"3-27":{핵심:"룻기는 사사 시대의 혼란 속에서 피어난 신실함의 이야기입니다. '어머니의 백성이 나의 백성이 되고 어머니의 하나님이 나의 하나님이 되리이다'라는 룻의 고백과 보아스의 기업 무를 자로서의 사랑이 아름답게 펼쳐집니다.",성품:"하나님은 이방인도 품으시는 분입니다. 룻은 모압 여인이었지만 하나님의 언약 백성 안으로 들어왔고, 다윗 왕의 조상이 되었습니다. 하나님의 사랑은 혈통과 민족을 초월합니다.",묵상:"어디를 가든 함께하겠다는 룻의 고백처럼, 오늘 하나님께 그런 신실함으로 나아갈 수 있나요? 어려운 상황에서도 하나님과 사람에게 신실한 것이 아름다운 삶의 열매를 맺습니다.",기도:"신실하신 하나님, 룻처럼 어떤 상황에서도 주문을 따르는 믿음을 허락하시고, 내 삶에서도 당신의 선한 섭리를 경험하게 하소서.",구절:"어머니의 백성이 나의 백성이 되고 어머니의 하나님이 나의 하나님이 되시리니 (룻기 1:16)"},
  ...
  const handleShare = async () => {
    ...
    try {
      if (navigator.share) {
        ...
        // 인앱 브라우저 (카카오톡 등) 대비 클립보드 자동 복사
        await navigator.clipboard.writeText(textToShare);
        alert("클립보드에 복사되었습니다!\n카카오톡 대화창에 '붙여넣기' 해주세요.");
      }
    } catch (err) {
      if (err.name !== 'AbortError') {
         // 그 외 에러 발생 시 최후의 보루 복사
         try {
           await navigator.clipboard.writeText(textToShare);
           alert("클립보드에 복사되었습니다!\n카카오톡 대화창에 '붙여넣기' 해주세요.");
         } catch(e) {
